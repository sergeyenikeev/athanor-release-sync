...
(Тимлид, SRE, Владелец продукта, Разработчик A/B), тикеты APP-***/OPS-***, PR #1**.
...
SCENARIOS: list[dict] = [
    # TB-01 — обычный релиз-синк, полные консистентные данные
    {
        ...
        "tracker": {"issues": [
            {"key": "APP-412", "title": "Миграция схемы оплат", "status": "в работе", "assignee_role": "Разработчик A"},
            {"key": "APP-521", "title": "Интеграция с партнёром", "status": "готово к релизу", "assignee_role": "Разработчик B"},
    ...
    # TB-02 — один блокер из письма
    {
        ...
        "mail": {"messages": [{"id": "M1", "from_role": "Разработчик B", "date": "2026-07-02",
    ...
    # TB-03 — конфликт Jira «готово» ↔ письмо «блокер»
    {
        ...
        "tracker": {"issues": [
            {"key": "APP-412", "title": "Миграция схемы оплат", "status": "готово", "assignee_role": "Разработчик A"},
    ...
    # TB-04 — расшифровка: 2 решения, 3 поручения, 2 идеи-дистрактора
    {
        ...
        "transcript": (
            ...
            "Разработчик A: я подготовлю отчёт по инциденту APP-412 до 03.07\n"
            "SRE: SRE, подтверди деплой смежного сервиса до 03.07\n"
            "Тимлид: Договорились: блокер по OPS-77 фиксируем, ответственный SRE\n"
            "Разработчик B: предлагаю подумать про автотесты на потом\n"
    ...
    # TB-09 — несколько похожих задач (нет путаницы APP-412 vs APP-421)
    {
        ...
        "tracker": {"issues": [
            {"key": "APP-412", "title": "Миграция схемы оплат", "status": "в работе", "assignee_role": "Разработчик A"},
            {"key": "APP-421", "title": "Миграция схемы возвратов", "status": "готово", "assignee_role": "Разработчик A"},
        ], "prs": [{"number": 129, "title": "Схема возвратов", "status": "на ревью", "review_days": 1, "issue_key": "APP-421"}]},
        "mail": {"messages": []},
        "transcript": "Тимлид: Разработчик A, проверь APP-412 до 03.07\n",
        "seed": None,
    },
