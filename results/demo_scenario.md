...
основа финального демо-видео: задачи APP-412/APP-521 (канонический live-снимок) — в сводке, конфликт
APP-412 (Jira «Готово» ↔ письмо «блокер») выявляется на live-данных.
...
- Демо-видео: `video/Athanor_Ouroboros_Project_Results_Demo.mp4` (2:20.50; F2 — реальный скринкаст UI Ouroboros, прогон a5336602, jetnight-opus, 5 MCP-вызовов, конфликт найден; F3 — реальные скринкасты Cloud UI Jira/Confluence/Calendar)

Длительность прогона < 3 мин (детерминированный rule-движок, ~1 с на цикл).
Длительность демо-видео — 2:20.50 (< 3 мин, критерий «ДЕМО-видео» 30%).