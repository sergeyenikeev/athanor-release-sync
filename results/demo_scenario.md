...
- Демо-видео: `video/Athanor_Ouroboros_Project_Results_Demo.mp4` (2:20.63; F2 — реальный скринкаст UI Ouroboros, прогон a5336602, jetnight-opus, 5 MCP-вызовов, конфликт найден; F3 — реальные скринкасты Cloud UI Jira/Confluence/Calendar)

Длительность прогона < 3 мин (детерминированный rule-движок, ~1 с на цикл).
Длительность демо-видео — 2:20.63 (< 3 мин, критерий «ДЕМО-видео» 30%).