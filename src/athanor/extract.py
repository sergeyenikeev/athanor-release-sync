...
качества для сравнения с LLM-движком. Метрики Project Results (канонический
прогон eval_20260719T_fixed) снимаются с rule-движка; LLM-прогон — замер пилота.
"""
...
# Обращение: «SRE, подтверди деплой …» / «Разработчик backend, за тобой …»
