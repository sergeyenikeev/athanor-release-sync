...
python test-instances/seed_atlassian.py       # создать KAN-1/KAN-2 (label alpha-demo), KAN-1 → Done
python test-instances/gen_live_case.py        # examples/demo_case_alpha_live (KAN-ключи)
...
этом уровне (проект KAN, KAN-1/KAN-2). URL/email в кадрах видео замаскированы.
