...
print(f"\nС live-бэкендом календарь+почта — из Google (Calendar — iCal, mail — IMAP),")
print(f"Jira — из Cloud (atlassian), PR/расшифровка — файлы кейса.")
print(f"\nПрогон:")
print(f"  MCP_BACKEND=live python mcp/serve_all.py   # терминал 1 (Jira + Google mail/Calendar + Confluence через MCP)")
