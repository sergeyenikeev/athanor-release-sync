...
Порты: Jira 9911 · Graph 9912 · Bitbucket 9913 · Confluence 9914. Локально, офлайн, без auth.
Контракты реальные (Atlassian Jira REST v2, Microsoft Graph, Bitbucket Cloud REST 2.0,
...
SERVERS = [
    ...
    (graph_server.Handler, 9912, "test-graph"),
