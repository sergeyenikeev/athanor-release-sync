...
RELEASE_PLAN_HTML = (
    ...
    "<li>Все задачи скоупа в статусе «Готово» в Jira; PR слиты и закрыты в Bitbucket.</li>"
     "<li>ППРБ-адаптер развёрнут в предпроде, дымные тесты ППРБ-адаптера зелёные.</li>"
    ...
    "блокере) → сверка на релиз-синке 03.07; приоритет Git/Jira выше переписки.</li>"
     "<li>Попадание релиза в окно заморозки ППРБ — открытый вопрос к SRE "
...
DECISION_LOG_HTML = (
    ...
    "<tr><td>30.06</td><td>APP-412 «Миграция на ППРБ» — принято в релиз 03.07</td>"
     "<td>Владелец продукта</td><td>Блокер миграции на ППРБ; перенос на "
    ...
    "<ul>"
     "<li>Попадает ли релиз 03.07 в окно заморозки ППРБ? — уточнить у SRE до "
